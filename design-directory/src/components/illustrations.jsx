...
function Illustration() {
  ...
  const [items,setItems] = useState(data.filter(item => item.category === 'illustration')); // State to manage the selected pricing type
  const filter_data_according_to_pricing = (pricing_type) => {
    if(pricing_type === 'free')
      return setItems(data.filter(item => item.pricing === 'free' && item.category === 'illustration'))
    else if(pricing_type === 'paid')
      return setItems(data.filter(item => item.pricing === 'paid' && item.category === 'illustration'))
    else
      return setItems(data.filter(item => item.pricing === 'free,paid' && item.category === 'illustration'))
  }
  ...
  return (
    <>
      ...
      <Meta property="og:description" content="Curated illustrations to inspire depth, emotion, and storytelling in your design projects." />
      ...
      <Meta name="twitter:description" content="Curated illustrations to inspire depth, emotion, and storytelling in your design projects." />
      ...
      (
        <>
          ...
          <div className="flex flex-col items-start justify-center h-auto w-full sm:w-auto p-[5px]">
            <span className="font-semibold text-[32px] md:text-[32px] lg:text-[40px] xl:text-[50px] 2xl:text-[60px] font-Outfit mt-[90px] md:mt-[40px] lg:mt-[50px] xl:mt-[50px] 2xl:mt-[50px]">Illustrations</span>
