...
function Mockups() {
  ...
  const [items,setItems] = useState(data.filter(item => item.category === 'mockup')); // State to manage the selected pricing type
  const filter_data_according_to_pricing = (pricing_type) => {
    if(pricing_type === 'free')
      return setItems(data.filter(item => item.pricing === 'free' && item.category === 'mockup'))
    else if(pricing_type === 'paid')
      return setItems(data.filter(item => item.pricing === 'paid' && item.category === 'mockup'))
    else
      return setItems(data.filter(item => item.pricing === 'free,paid' && item.category === 'mockup'))
  }
  ...
  return (
    <>
      ...
      <Meta name="description" content="curated library of high-quality mockups to showcase your designs in real-world contexts" />
      <Meta property="og:title" content="Mockups | Design Directory" />
      <Meta property="og:description" content="curated library of high-quality mockups to showcase your designs in real-world contexts" />
      ...
      <Meta name="twitter:description" content="curated library of high-quality mockups to showcase your designs in real-world contexts" />
