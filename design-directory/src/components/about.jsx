...
export default function About() {
    return (
        <>
            <div className="flex flex-col items-start justify-center w-auto h-auto bg-white ml-[12px] mr-[20px] mt-[45px]">
                <h1 className="text-[32px] font-Outfit font-bold mb-[5px]">About Us</h1>
                ...
                <ul className="list-disc ml-[30px] mb-2">
                    <li className="text-[15px] font-Outfit font-semibold text-[#525252]">Handpicked for Qaulity</li>
                    <li className="text-[15px] font-Outfit font-semibold text-[#525252]">Mostly free or freemium</li>
                    <li className="text-[15px] font-Outfit font-semibold text-[#525252]">Built to help you grow as a designer</li>
                </ul>
                <p className="text-[15px] font-Outfit font-semibold text-justify text-[#525252] mb-2">
