      ...
      (
        <>
          ...
          <div className="flex flex-col items-start justify-center h-auto w-full sm:w-auto p-[5px]">
            <span className="font-semibold text-[32px] md:text-[32px] lg:text-[40px] xl:text-[50px] 2xl:text-[60px] font-Outfit mt-[90px] md:mt-[40px] lg:mt-[50px] xl:mt-[50px] 2xl:mt-[50px]">Design Inspiration</span>
