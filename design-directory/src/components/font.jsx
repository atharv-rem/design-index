...
function Font() {
  ...
  const [items,setItems] = useState(data.filter(item => item.category === 'font')); // State to manage the selected pricing type
  const filter_data_according_to_pricing = (pricing_type) => {
    if(pricing_type === 'free')
      return setItems(data.filter(item => item.pricing === 'free' && item.category === 'font'))
    else if(pricing_type === 'paid')
      return setItems(data.filter(item => item.pricing === 'paid' && item.category === 'font'))
    else
      return setItems(data.filter(item => item.pricing === 'free,paid' && item.category === 'font'))
  }
  ...
  return (
    <>
      ...
      <Meta name="description" content="curated selection of font libraries to enhance your typography with style, clarity, and brand identity" />
      <Meta property="og:title" content="Fonts | Design Directory" />
      <Meta property="og:description" content="curated selection of font libraries to enhance your typography with style, clarity, and brand identity" />
      ...
      <Meta name="twitter:description" content="curated selection of font libraries to enhance your typography with style, clarity, and brand identity" />
      ...
      (
        <>
          ...
          <div className="flex flex-col items-start justify-center h-auto w-full sm:w-auto p-[5px]">
            <span className="font-semibold text-[32px] md:text-[32px] lg:text-[40px] xl:text-[50px] 2xl:text-[60px] font-Outfit mt-[90px] md:mt-[40px] lg:mt-[50px] xl:mt-[50px] 2xl:mt-[50px]">Fonts</span>
