...
export default function PrivacyPolicy() {
    return (
        <>
            <div className="flex flex-col items-start justify-start w-auto h-auto bg-white ml-[12px] mr-[20px] mt-[45px]">
                <p className="text-[32px] font-Outfit font-bold mb-[5px]">Privacy Policy</p>
                <p className="text-[15px] font-Outfit font-semibold text-justify text-black mb-2 ">
                    Effective Date: July 20, 2025
                </p>
                <p className="text-[15px] font-Outfit font-semibold text-justify text-[#525252] mb-2 ">
                ...
                <ul className="list-disc ml-[30px] mb-2">
                    <li className='text-[15px] font-Outfit font-semibold text-[#525252]'>IP address</li>
                    <li className='text-[15px] font-Outfit font-semibold text-[#525252]'>Browser type and version</li>
                    <li className='text-[15px] font-Outfit font-semibold text-[#525252]'>Operating system</li>
                    <li className='text-[15px] font-Outfit font-semibold text-[#525252]'>Referring website</li>
                    <li className='text-[15px] font-Outfit font-semibold text-[#525252]'>Pages visited on our site</li>
                </ul>
                <p className="text-[15px] font-Outfit font-semibold text-justify text-[#525252] mb-2">
